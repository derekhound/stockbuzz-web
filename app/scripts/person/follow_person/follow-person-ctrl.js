...
angular.module('person')
	...
	.controller('perFollowPersonCtrl', ['$scope', '$state', '$location', '$translate', 'resUser', 'resSocial', function($scope, $state, $location, $translate, resUser, resSocial) {
