...
angular.module('person')
	...
	.controller('perFollowerCtrl', ['$scope', '$state', '$location', '$translate', 'resUser', 'resSocial', function($scope, $state, $location, $translate, resUser, resSocial) {
		...
		$scope.getList = function() {
			...
			resSocial.get_followers_by_page($scope.list.since_id, $scope.list.count, user_id).then(function(data) {
